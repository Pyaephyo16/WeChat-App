...
const localNotificationChannelDescription = "This channel is used for important notifications.";
    ...
    FirebaseMessaging.onMessage.listen((remoteMessage) {
      ...
      if (notification != null && android != null) {
        flutterLocalNotificationsPlugin.show(
          ...
          payload: remoteMessage.data['id'].toString(),
        );
      }
    });
